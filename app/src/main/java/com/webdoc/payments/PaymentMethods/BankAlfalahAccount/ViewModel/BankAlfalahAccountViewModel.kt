package com.webdoc.payments.PaymentMethods.BankAlfalahAccount.ViewModel
...
class BankAlfalahAccountViewModel  //todo : constructor
    ...
    // todo: MLD LIVE DATA
    private val MLD_open_BankAlfalah_Account_Webview = MutableLiveData<String>()


    fun LD_open_BankAlfalah_Account_webview(): LiveData<String> {
    ...
    fun openWebviewBankAlfalahAccount(webView: WebView?, url: String?) {
        wb = webView
